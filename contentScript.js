 ...
 * @LastEditTime: 2022-08-04 22:20:10
    ...
    const other = () => {
        ...
        if (banner) {
            if (category == 1) {
                ...
                showPurpose.click()
                setTimeout(() => {
                    let performanceCookies = document.getElementById('ot-group-id-C0002')
                    ...
                    any1 == 1 ? performanceCookies.checked = true : console.log('any1: ' + any1)
